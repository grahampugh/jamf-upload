...
NOTES:
All functions are in JamfUploaderLib/JamfPolicyDeleterBase.py
"""
...
from JamfUploaderLib.JamfPolicyDeleterBase import (  # noqa: E402
    JamfPolicyDeleterBase,
)

__all__ = ["JamfPolicyDeleter"]


class JamfPolicyDeleter(JamfPolicyDeleterBase):
    description = (
