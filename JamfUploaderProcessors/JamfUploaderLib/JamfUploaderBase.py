...
class JamfUploaderBase(Processor):
    ...
    def api_endpoints(self, object_type, uuid=""):
        ...
        api_endpoints = {
            ...
            "blueprint_deploy": f"api/blueprints/v1/blueprints/{uuid}/deploy",
            "blueprint_undeploy": f"api/blueprints/v1/blueprints/{uuid}/undeploy",
    ...
    def object_list_types(self, object_type):
        ...
        object_list_types = {
            ...
            "blueprint_deploy": "blueprints",
            "blueprint_undeploy": "blueprints",
            "category": "categories",
            "computer": "computers",
