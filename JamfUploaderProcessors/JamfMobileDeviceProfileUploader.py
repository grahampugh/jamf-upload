...
"""
JamfMobileDeviceProfileUploader processor for uploading mobile device configuration profiles
...
__all__ = ["JamfMobileDeviceProfileUploader"]


class JamfMobileDeviceProfileUploader(JamfUploaderBase):
    description = (
