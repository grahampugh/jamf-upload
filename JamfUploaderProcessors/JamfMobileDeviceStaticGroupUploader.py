...
NOTES:
All functions are in JamfUploaderLib/JamfMobileDeviceStaticGroupUploaderBase.py
"""
...
from JamfUploaderLib.JamfMobileDeviceStaticGroupUploaderBase import (  # pylint: disable=import-error, wrong-import-position
    JamfMobileDeviceStaticGroupUploaderBase,
)

__all__ = ["JamfMobileDeviceStaticGroupUploader"]


class JamfMobileDeviceStaticGroupUploader(JamfMobileDeviceStaticGroupUploaderBase):
    ...
    input_variables = {
        ...
        "group_description": {
            "required": False,
            "description": "Mobile Device Group description",
        ...
        "clear_assignments": {
            "required": False,
            "description": "Clear assignments in an existing Mobile Device Group if True.",
            "default": False,
        },
        "sleep": {
            "required": False,
